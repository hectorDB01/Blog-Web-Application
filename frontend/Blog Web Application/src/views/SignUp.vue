...
const handleSubmit = (e, user) => {
  ...
  makeUsersService.createUser(user.value)
  success.value = true
}
          ...
          <div class="card border border-light-subtle rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <div class="alert alert-success" v-if="success">
                <strong>Success!</strong> You just have regisered
                <strong>Your Account</strong> successfully
              </div>
              <form @submit.prevent="handleSubmit($event, user)">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <p class="m-0 text-secondary text-center">
                    ...
                    <a href="/signin" class="link-primary text-decoration-none">Sign in</a>
                  </p>
                </div>
              </div>
              <div class="row">
